  ...
  <div class="talent-container">
    <div class="talent-sticky-top">
      <div class="talent-search-box">
        ...
        <input type="text" placeholder="搜索占位..." class="talent-search-input" />
      </div>
    </div>
...
.placeholder-title1 { font-size: 16px; font-weight: 700; color: var(--text-main); margin: 20px 20px 20px;   text-align: left;}
.placeholder-desc { font-size: 16px; color: var(--text-main); text-align: left;}
.qq-link-wrap {
  text-align: left;
  padding: 0 10px;
}
